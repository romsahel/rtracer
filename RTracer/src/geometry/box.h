...
public:
	...
	{
		m_sides[0].position = point3(0, 0, -size.z() * 0.5f);
		m_sides[0].width = size.x();
		m_sides[0].height = size.y();
		m_sides[0].update();
		m_sides[1].position = point3(0, 0, size.z() * 0.5f);
		m_sides[1].width = size.x();
		m_sides[1].height = size.y();
		m_sides[1].update();

		m_sides[2].position = point3(-size.x() * 0.5f, 0, 0);
		m_sides[2].width = size.y();
		m_sides[2].height = size.z();
		m_sides[2].update();
		m_sides[3].position = point3(size.x() * 0.5f, 0, 0);
		m_sides[3].width = size.y();
		m_sides[3].height = size.z();
		m_sides[3].update();

		m_sides[4].position = point3(0, size.y() * 0.5f, 0);
		m_sides[4].width = size.z();
		m_sides[4].height = size.x();
		m_sides[4].update();
		m_sides[5].position = point3(0, -size.y() * 0.5f, 0);
